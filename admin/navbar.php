    ...
    <nav class="header__hidden-burgernav">
        <ul class="header__list">
            ...
            <ul class="header__sub-list header__sub-list--hidden" id="sub-products">
               ...
               <a href="" class="header__sub-item-link"><li class="header__sub-list-item">Kategori 3</li></a>
               <a href="" class="header__sub-item-link"><li class="header__sub-list-item">Kategori 4</li></a>
            </ul>
            <li class="header__list-item" id="order">Beställningar</li>
            <ul class="header__sub-list header__sub-list--hidden" id="sub-order">
               <a href="" class="header__sub-item-link"><li class="header__sub-list-item">Aktiva</li></a>
               <a href="" class="header__sub-item-link"><li class="header__sub-list-item">Slutförda</li></a>
            </ul>
            <a href="" class="header__item-link"><li class="header__list-item">Webbshoppen</li></a>
        </ul>
    </nav>
